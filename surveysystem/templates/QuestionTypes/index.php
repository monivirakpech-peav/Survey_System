 ...
 * @var iterable<\App\Model\Entity\QuestionType> $questionTypes
 */
?>
<div class="questionTypes index content">
    <?= $this->Html->link(__('New Question Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
